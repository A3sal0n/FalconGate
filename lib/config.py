    ...
    def run(self):
        ...
        while 1:
            ...
            if stamp != self._cached_stamp_user:
                ...
                homenet.user_domain_blacklist = (user_config.get('main', 'domain_blacklist').translate(None, '"\n\r ')).strip('"').split(",")
                homenet.user_domain_whitelist = (user_config.get('main', 'domain_whitelist').translate(None, '"\n\r ')).strip('"').split(",")
                ...
                homenet.allow_tor = user_config.get('main', 'allow_tor').translate(None, '"\n\r ').strip('"')
                homenet.cloud_malware_sandbox = user_config.get('main', 'cloud_malware_sandbox').translate(None, '"\n\r ').strip('"')
