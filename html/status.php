...
if (!$result){
    ...
    echo ("<h1>FalconGate network configuration</h1>");
    echo ('<table class=TFtable width=80% halign=left>');
    ...
    $result = CallAPI('POST', 'http://127.0.0.1:5000/api/v1.0/falcongate/status', json_encode($data));
    $obj = json_decode($result, true);
    echo ('<br><h1>Active home devices</h1>
    <table class=TFtable width=80% halign=left><tr>
